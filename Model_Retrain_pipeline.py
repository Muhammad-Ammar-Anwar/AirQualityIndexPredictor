...
def run_retrain():
    ...
    print(f"  {'-'*28} {'-'*10} {'-'*9} {'-'*8}")
    print(f"  {'0-24h  (t+1  to t+24 )':<28} {'9.596':>10} {'6.256':>9} {'0.8715':>8}")
    print(f"  {'25-48h (t+25 to t+48 )':<28} {'12.895':>10} {'9.996':>9} {'0.7361':>8}")
    print(f"  {'49-72h (t+49 to t+72 )':<28} {'17.993':>10} {'12.383':>9} {'0.5365':>8}")
